...
fn test_integer_equals_same() {
    assert_eq!(
        run_ok("int main() { int a = 42; bool r = a.equals(42); if (r) { return 1; } return 0; }"),
        1
    );
}
...
fn test_integer_equals_different() {
    assert_eq!(
        run_ok("int main() { int a = 42; bool r = a.equals(99); if (r) { return 0; } return 1; }"),
        1
    );
}
...
fn test_integer_equals_wrong_type_returns_false() {
    assert_eq!(
        run_ok(
            r#"int main() { int a = 42; bool r = a.equals("hello"); if (r) { return 0; } return 1; }"#
        ),
        1
    );
}
...
fn test_float_equals_same() {
    assert_eq!(
        run_ok(
            "int main() { float a = 3.14; bool r = a.equals(3.14); if (r) { return 1; } return 0; }"
        ),
        1
    );
}
...
fn test_float_equals_different() {
    assert_eq!(
        run_ok(
            "int main() { float a = 3.14; bool r = a.equals(2.71); if (r) { return 0; } return 1; }"
        ),
        1
    );
}
...
fn test_float_equals_wrong_type_returns_false() {
    assert_eq!(
        run_ok(
            "int main() { float a = 1.0; bool r = a.equals(1); if (r) { return 0; } return 1; }"
        ),
        1
    );
}
...
fn test_boolean_equals_true_true() {
    assert_eq!(
        run_ok(
            "int main() { bool a = true; bool r = a.equals(true); if (r) { return 1; } return 0; }"
        ),
        1
    );
}
...
fn test_boolean_equals_true_false() {
    assert_eq!(
        run_ok(
            "int main() { bool a = true; bool r = a.equals(false); if (r) { return 0; } return 1; }"
        ),
        1
    );
}
...
fn test_boolean_equals_wrong_type_returns_false() {
    assert_eq!(
        run_ok(
            "int main() { bool a = true; bool r = a.equals(1); if (r) { return 0; } return 1; }"
        ),
        1
    );
}
...
fn test_string_equals_same() {
    assert_eq!(
        run_ok(
            r#"int main() { string s = "hello"; bool r = s.equals("hello"); if (r) { return 1; } return 0; }"#
        ),
        1
    );
}
...
fn test_string_equals_different() {
    assert_eq!(
        run_ok(
            r#"int main() { string s = "hello"; bool r = s.equals("world"); if (r) { return 0; } return 1; }"#
        ),
        1
    );
}
...
fn test_string_equals_wrong_type_returns_false() {
    assert_eq!(
        run_ok(
            "int main() { string s = \"hi\"; bool r = s.equals(42); if (r) { return 0; } return 1; }"
        ),
        1
    );
}
...
fn test_char_equals_same() {
    assert_eq!(
        run_ok(
            "int main() { char c = 'a'; bool r = c.equals('a'); if (r) { return 1; } return 0; }"
        ),
        1
    );
}
...
fn test_char_equals_different() {
    assert_eq!(
        run_ok(
            "int main() { char c = 'a'; bool r = c.equals('b'); if (r) { return 0; } return 1; }"
        ),
        1
    );
}
...
fn test_char_equals_wrong_type_returns_false() {
    assert_eq!(
        run_ok(
            "int main() { char c = 'a'; bool r = c.equals(97); if (r) { return 0; } return 1; }"
        ),
        1
    );
}
